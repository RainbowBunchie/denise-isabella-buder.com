    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Denise Buder Portfolio.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Denise Buder Portfolio, accessible
          from
          <a
            href="https://denise-buder.netlify.app/"
            rel="external nofollow noopener"
            target="_blank"
            >https://denise-buder.netlify.app/</a
          >
        </p>
      </li>
      <li>
